...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($equipo,['route' => ['admin.equipos.update', $equipo], 'files' => true, 'method' => 'put']) !!}
            ...
            <div class="row mb-3">
               ...
               <div class="col">
                    ...
                    @isset ($equipo->image)
                        <img id="picture" src="{{asset($equipo->image->url)}}">
                    @else
            ...
            {!! Form::submit('Actualizar Integrante',['class' => 'btn btn-primary']) !!}
