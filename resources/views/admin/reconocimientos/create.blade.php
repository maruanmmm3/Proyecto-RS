...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::open(['route' => 'admin.reconocimientos.store', 'files' => true]) !!}
        ...
        <div class="form-group">
            ...
            <div class="row mb-3">
               ...
               <div class="col">
                    ...
                    @isset ($reconocimientos->image)
                        <img id="picture" src="{{Storage::url($reconocimientos->image->url)}}">
                    @else
            ...
            {!! Form::submit('Crear Reconocimiento',['class' => 'btn btn-primary']) !!}
