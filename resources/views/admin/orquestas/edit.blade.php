...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($orquestum,['route' => ['admin.orquestas.update', $orquestum], 'files' => true, 'method' => 'put']) !!}
            ...
            <div class="row mb-3">
               ...
               <div class="col">
                    ...
                    @isset ($orquestum->image)
                        <img id="picture" src="{{asset($orquestum->image->url)}}">
                    @else
            ...
            {!! Form::submit('Actualizar Orquesta',['class' => 'btn btn-primary']) !!}
